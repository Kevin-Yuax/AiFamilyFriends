...
<template>
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <!-- Navbar -->
      <nav class="navbar w-full bg-base-100 shadow-lg">
        ...
        <div class="navbar-center w-4/5 max-w-180">
          ...
          <button class="btn join-item rounded-r-full gap-0"><SearchIcon/>
            搜索</button>
        </div>
        </div>

        <div class="navbar-end">
          <button class="btn btn-ghost text-lg hover:bg-gray-100 hover:text-gray-900 active:bg-gray-200 transition-colors duration-200 px-6">登 录</button>
        </div>
      </nav>
      <!-- Page content here -->
      <slot>
